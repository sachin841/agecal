...
variables.forEach(varName => {
    ...
    try {
        ...
        // Replace onclick="calculateGravel()" with onclick="calculate('{Calculator Name}')"
        content = content.replace(
            /onclick="calculateGravel\(\)"/g,
            `onclick="calculate('${varName}')"`
        );
...
console.log("\nSuccessfully updated onclick attributes in all calculator pages.");
